...
public class QuerySearchOnly
{
                                   ...
                                   int numberOfItineraries)
  {
    ...
    //transaction_search_unsafe(originCity, destinationCity, directFlight, dayOfMonth, numberOfItineraries);
  }
  
  private Flight fPush (ResultSet re, boolean ortwo) throws SQLException {
	  int second = 0;
	  if (!ortwo) {
		  second = 18;
	  }
